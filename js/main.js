...
// 검색버튼 클릭시 검색창 나오고, 바탕 클릭시 검색창 닫힘
$(function(){
    // 버튼 클릭시 검색창 나옴
    ...
    // 바탕 클릭시 검색창 닫힘
    // html문서 클릭시 클릭된 요소를 기준으로 가장 가까운 조상 찾음
    // 찾은 요소가 없을 시, 컨테이너 숨김. 고로 내부 영역이 아닌 바깥 영역 클릭시 검색창이 숨겨지는 구조가 됨
